...
export default function About() {
  ...
  return (
    ...
    >
      <div className="crt w-full xl:w-4/5 h-[90%] md:h-4/5 overflow-hidden bg-violet-950 border-2 border-purple-600 relative text-shadow shadow-pink-500 text-pink-100 font-alien rounded-md">
