export default function About() {
  return (
    ...
    >
      <div className="w-2/3 h-3/4 bg-purple-900 border-2 border-purple-600 relative text-shadow-sm shadow-white text-pink-100 font-alien  ">
        <div className="crt"></div>
        <div id="aboutText" className=" w-3/5 h-full p-4">
