      ...
      {loadingProjects
        ...
        !openProject
          ? <div className=" w-full min-h-auto h-full relative flex flex-col lg:flex-row z-10 text-shadow-lg shadow-pink-400 text-pink-100 ">
            <ProjectShowcase classes="w-full lg:w-3/4 h-1/3 lg:h-full lg:border-r-2 border-purple-600" setOpenProject={setOpenProject} projectName="DizManga" />
            <ProjectShowcase classes="w-full h-1/3 border-b-2 border-t-2 lg:border-r-2 border-purple-600 lg:hidden" setOpenProject={setOpenProject} projectName="Store Finder" />
            ...
            <div className="w-full flex-col justify-center items-center gap-4 hidden lg:flex">
              <div className="w-full h-4/5 flex border-b-2 border-purple-600 ">
                <ProjectShowcase classes="w-1/2 h-full border-r-2 border-purple-600" setOpenProject={setOpenProject} projectName="Store Finder" />
