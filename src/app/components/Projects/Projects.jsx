      ...
      {loadingProjects
        ...
        !openProject
          ? <div className=" w-full min-h-auto h-full relative flex flex-col md:flex-row z-10 text-shadow-lg shadow-pink-400 text-pink-100 ">
            ...
            <ProjectShowcase classes="w-full h-1/3 border-b-2 border-t-2 md:border-r-2 border-purple-600 md:hidden" setOpenProject={setOpenProject} projectName="Store Finder" />
